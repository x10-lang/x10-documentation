...
%%METHOD-SELECTION%% 
%%METHOD-SELECTION%% %~~gen ^^^ Functions80
%%METHOD-SELECTION%% % package Functions2.Span;
%%METHOD-SELECTION%% %~~vis
...
%%METHOD-SELECTION%% %~~siv
%%METHOD-SELECTION%% % class Hook{ def run() {Span.example(); return true;}}
%%METHOD-SELECTION%% %~~neg
%%METHOD-SELECTION%% \noindent
%%METHOD-SELECTION%% 
%%METHOD-SELECTION%% 
%%METHOD-SELECTION%% In \xcd`example()`, 
%%METHOD-SELECTION%% %~~exp~~`~~`~~ digit:Span~~class Span(low:Int, high:Int) {def this(low:Int, high:Int) {property(low,high);} def between(n:Int) = low <= n && n <= high;} ^^^ Functions90
...
%%METHOD-SELECTION%% %~~exp~~`~~`~~ digit:Span~~class Span(low:Int, high:Int) {def this(low:Int, high:Int) {property(low,high);} def between(n:Int) = low <= n && n <= high;} ^^^ Functions100
