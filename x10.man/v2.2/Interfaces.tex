...
\bard{The following stuff needs a home (maybe):}
...
\bard{OK, back to the real chapter now}
...
%##(InterfaceDecl TypeParamsI Guard ExtendsInterfaces InterfaceBody InterfaceMemberDecl
\begin{bbgrammar}
%(FROM #(prod:InterfaceDecl)#)
