...
\end{xten}
%~~siv
% class Hook{ def run() {(new Example()).example(); return true;}}
%~~neg
...
class Two[T,U]{
  ...
  def m(x:U)=4;
  static def example() {
    val t12 : Two[Int, Any] = new Two[Int, Any]();
    // ERROR: t12.m(2);
    val t13  :Two[String, Any] = new Two[String, Any]();
    t13.m("ferret");
    val t14 : Two[Boolean, Boolean] = new Two[Boolean,Boolean]();
    // ERROR: t14.m(true);
  }
}
\end{xten}
