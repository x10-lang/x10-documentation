...
%##(ClassDecln TypeParamsI TypeParamIList Properties PropertyList Property Guard Super Interfaces InterfaceTypeList ClassBody ClassBodyDeclns ClassMemberDecln
\begin{bbgrammar}
...
%(FROM #(prod:ClassBody)#)
           ClassBody \: \xcd"{" ClassBodyDeclns\opt \xcd"}" & (\ref{prod:ClassBody}) \\
%(FROM #(prod:ClassBodyDeclns)#)
     ClassBodyDeclns \: ClassBodyDecln & (\ref{prod:ClassBodyDeclns}) \\
                     \| ClassBodyDeclns ClassBodyDecln \\
%(FROM #(prod:ClassMemberDecln)#)
    ClassMemberDecln \: FieldDecln & (\ref{prod:ClassMemberDecln}) \\
                     \| MethodDecln \\
                     \| PropMethodDecln \\
                     \| TypeDecln \\
\end{bbgrammar}
...
%##(MethMods MethodDeclaration TypeParams Formals FormalList HasResultType MethodBody
\begin{bbgrammar}
%(FROM #(prod:MethMods)#)
