...
(\arabic{equation}) & AmbiguousName \refstepcounter{equation}\label{prod:AmbiguousName}  \: Id  \\
...
(\arabic{equation}) & Arguments \refstepcounter{equation}\label{prod:Arguments}  \: \xcd"(" ArgumentList\opt \xcd")"  \\
...
(\arabic{equation}) & MethodInvocation \refstepcounter{equation}\label{prod:MethodInvocation}  \: MethodPrimaryPrefix \xcd"(" ArgumentList\opt \xcd")"  \\
...
(\arabic{equation}) & TypeDefDecl \refstepcounter{equation}\label{prod:TypeDefDecl}  \: Mods\opt \xcd"type" Id TypeParams\opt Formals\opt Guard\opt \xcd"=" Type \xcd";"  \\
