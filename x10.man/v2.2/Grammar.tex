...
(\arabic{equation}) & AtExp \refstepcounter{equation}\label{prod:AtExp}  \: \xcd"at" \xcd"(" PlaceExp \xcd")" ClosureBody  \\
...
(\arabic{equation}) & AtStatement \refstepcounter{equation}\label{prod:AtStatement}  \: \xcd"at" \xcd"(" PlaceExp \xcd")" Statement  \\
