...
(\arabic{equation}) & AtExp \refstepcounter{equation}\label{prod:AtExp}  \: \xcd"at" PlaceExpSingleList ClosureBody  \\
...
(\arabic{equation}) & AtStatement \refstepcounter{equation}\label{prod:AtStatement}  \: \xcd"at" PlaceExpSingleList Statement  \\
...
(\arabic{equation}) & BlockStatement \refstepcounter{equation}\label{prod:BlockStatement}  \: LocVarDeclStmt  \\
...
(\arabic{equation}) & BlockStatements \refstepcounter{equation}\label{prod:BlockStatements}  \: BlockStatement  \\
...
(\arabic{equation}) & ClassDecl \refstepcounter{equation}\label{prod:ClassDecl}  \: StructDecl  \\
...
(\arabic{equation}) & ClassInstCreationExp \refstepcounter{equation}\label{prod:ClassInstCreationExp}  \: \xcd"new" TypeName TypeArgs\opt \xcd"(" ArgumentList\opt \xcd")" ClassBody\opt  \\
 ...
 &    \| ValueOrTypeName \xcd"." \xcd"new" Id TypeArgs\opt \xcd"(" ArgumentList\opt \xcd")" ClassBody\opt \\
...
(\arabic{equation}) & Clock \refstepcounter{equation}\label{prod:Clock}  \: Exp  \\
...
(\arabic{equation}) & ClockList \refstepcounter{equation}\label{prod:ClockList}  \: Clock  \\
...
(\arabic{equation}) & ClockedClause \refstepcounter{equation}\label{prod:ClockedClause}  \: \xcd"clocked" \xcd"(" ClockList \xcd")"  \\
...
(\arabic{equation}) & ClosureExp \refstepcounter{equation}\label{prod:ClosureExp}  \: Formals Guard\opt HasResultType\opt Offers\opt \xcd"=>" ClosureBody  \\
...
(\arabic{equation}) & Conjunction \refstepcounter{equation}\label{prod:Conjunction}  \: Exp  \\
...
(\arabic{equation}) & CtorDecl \refstepcounter{equation}\label{prod:CtorDecl}  \: Mods\opt \xcd"def" \xcd"this" TypeParams\opt Formals Guard\opt HasResultType\opt Offers\opt CtorBody  \\
...
(\arabic{equation}) & DepParams \refstepcounter{equation}\label{prod:DepParams}  \: \xcd"{" ExistentialList\opt Conjunction\opt \xcd"}"  \\
...
(\arabic{equation}) & ExistentialList \refstepcounter{equation}\label{prod:ExistentialList}  \: Formal  \\
...
(\arabic{equation}) & FinishExp \refstepcounter{equation}\label{prod:FinishExp}  \: \xcd"finish" \xcd"(" Exp \xcd")" Block  \\
...
(\arabic{equation}) & FunctionType \refstepcounter{equation}\label{prod:FunctionType}  \: TypeParams\opt \xcd"(" FormalList\opt \xcd")" Guard\opt Offers\opt \xcd"=>" Type  \\
...
(\arabic{equation}) & InterfaceDecl \refstepcounter{equation}\label{prod:InterfaceDecl}  \: NormalInterfaceDecl  \\
...
(\arabic{equation}) & MethodDecl \refstepcounter{equation}\label{prod:MethodDecl}  \: MethMods \xcd"def" Id TypeParams\opt Formals Guard\opt HasResultType\opt Offers\opt MethodBody  \\
...
(\arabic{equation}) & MethodSelection \refstepcounter{equation}\label{prod:MethodSelection}  \: MethodName \xcd"." \xcd"(" FormalList\opt \xcd")"  \\
...
(\arabic{equation}) & NormalClassDecl \refstepcounter{equation}\label{prod:NormalClassDecl}  \: Mods\opt \xcd"class" Id TypeParamsI\opt Properties\opt Guard\opt Super\opt Interfaces\opt ClassBody  \\
...
(\arabic{equation}) & NormalInterfaceDecl \refstepcounter{equation}\label{prod:NormalInterfaceDecl}  \: Mods\opt \xcd"interface" Id TypeParamsI\opt Properties\opt Guard\opt ExtendsInterfaces\opt InterfaceBody  \\
...
(\arabic{equation}) & OfferStatement \refstepcounter{equation}\label{prod:OfferStatement}  \: \xcd"offer" Exp \xcd";"  \\
...
(\arabic{equation}) & Offers \refstepcounter{equation}\label{prod:Offers}  \: \xcd"offers" Type  \\
...
(\arabic{equation}) & OperatorFunction \refstepcounter{equation}\label{prod:OperatorFunction}  \: TypeName \xcd"." \xcd"+"  \\
...
(\arabic{equation}) & PlaceExp \refstepcounter{equation}\label{prod:PlaceExp}  \: Exp  \\
...
(\arabic{equation}) & PlaceExpSingleList \refstepcounter{equation}\label{prod:PlaceExpSingleList}  \: \xcd"(" PlaceExp \xcd")"  \\
...
(\arabic{equation}) & TypeParamI \refstepcounter{equation}\label{prod:TypeParamI}  \: Id  \\
...
(\arabic{equation}) & TypeParamIList \refstepcounter{equation}\label{prod:TypeParamIList}  \: TypeParamI  \\
...
(\arabic{equation}) & ValueOrTypeName \refstepcounter{equation}\label{prod:ValueOrTypeName}  \: Id  \\
...
(\arabic{equation}) & VoidType \refstepcounter{equation}\label{prod:VoidType}  \: \xcd"void"  \\
