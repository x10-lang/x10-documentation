...
\xcd`athome (*) S` and 
\xcd`athome S` 
allow a block of assignments without specifying the variables being assigned
to, which is convenient for a small set of assignments. 
They 
are both equivalent to \xcd`athome(V;F)S`,
where: 
\begin{itemize}
