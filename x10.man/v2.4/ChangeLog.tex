...
a result, virtually all \Xten{} v2.3 programs will need at least minor
updates to be valid \Xten{} 2.4 programs.  The driving motivation for
the change was a long-contemplated strategic decision to shift to from
int-based (32-bit) to long-based (64-bit) indexing for all \Xten{}
arrays. This change enables \Xten{} to better utilize the rapidly
...
In more detail the major changes made in the \Xten{} v2.4 release are
\begin{enumerate}
...
\item The main method signature is changed from \xcd{Array[String]} to
  \xcd{Rail[String]}. 
\item \xcd{x10.util.IndexedMemoryChunk} has been deprecated and all
  uses have been removed from the \Xten{} standard library.
  \xcd{IndexedMemoryChunk} will be removed in the next release of \Xten{}.
