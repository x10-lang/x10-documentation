...
Java. On top of \xcd{Rail}'s, more sophisticated array abstractions
...
libraries in the \xcd{x10.array} and \xcd{x10.regionarray} packages.
...
\xcd{x10.regionarray} where absolutely necessary.  We also encourage
programmers to use the classes of \xcd{x10.array} as an example of how
...
\section{\xcd{x10.array}: Simple Arrays}

WRITE ME

\section{\xcd{x10.regionarray}: Flexible Arrays}
