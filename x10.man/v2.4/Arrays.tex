...
\item Local multi-dimensional arrays; both \xcd`simplearray` and \xcd`regionarray`
\item Distributed multi-dimensional arrays; both \xcd`simplearray` and \xcd`regionarray`
\end{itemize}
