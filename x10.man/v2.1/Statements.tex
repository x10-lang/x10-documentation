...
block.  Variables declared in such statements shadow variables of the same
...
% TODO The following grammar is inconsistent with the grammar in the appendix.
%##(LabeledStatement
\begin{bbgrammar}
%(FROM #(prod:LabeledStatement)#)
