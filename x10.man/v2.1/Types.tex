...
\index{constraint!properties in}
...
The \xcd`Triangle` struct automatically gets a ternary constructor which takes
...
\label{LCA}
\index{type!common ancestor}
\index{type!upper bound}
...
\index{val!type inference}
\index{type inference!val}
