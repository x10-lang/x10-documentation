...
%%GRAMMAR%%  Formal
%%GRAMMAR%%          \: FormalModifier\star \xcd"var" VarDeclaratorWithType \\
%%GRAMMAR%%          \| FormalModifier\star \xcd"val" VarDeclaratorWithType \\
%%GRAMMAR%%          \| FormalModifier\star VarDeclaratorWithType \\
%%GRAMMAR%%          \| Type \\
%%GRAMMAR%%  FormalModifier \: Annotation \\
%%GRAMMAR%%  
%%GRAMMAR%%  \end{grammar}
%%GRAMMAR%%  
