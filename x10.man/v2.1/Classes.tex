...
\noo{Are there any other field qualifiers?}
...
\noo{The following para seems misplaced or redundant:}
...
definitely assigned.\Sectref{DefiniteAssign}  For example: 
%~~gen
