...
on a class (ad hoc polymorphism). Methods may be declared \Xcd{public},
\Xcd{private}, \Xcd{protected}, or given default access rights.
...
respectively.  
It must be the case that the compiler can determine a single
method defined on \xcd"T" with argument type
\xcdmath"T$_1$", \dots \xcdmath"T$_n$"; otherwise, a
compile-time error is declared. However,  the \Xten{} type \xcd"T"
