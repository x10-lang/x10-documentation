...
\section{Distributed Array Construction}\label{ArrayInitializer}\label{array!creation}
...
\subsection{Constant promotion}\label{ConstantArray}\index{arrays!constant
  promotion}
