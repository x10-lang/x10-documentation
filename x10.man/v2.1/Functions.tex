...
\begin{bbgrammar}
 ClosureExp    \: FormalParams WhereClause\opt HasResultType\opt Offers\opt \xcd"=>" ClosureBody & (\ref{prod:ClosureExp})\\%<FROM #(prod:ClosureExp)#
 ...
 ExistentialList    \: FormalParam & (\ref{prod:ExistentialList})\\%<FROM #(prod:ExistentialList)#
    \| ExistentialList \xcd";" FormalParam\\
 HasResultType    \: \xcd":" Type & (\ref{prod:HasResultType})\\%<FROM #(prod:HasResultType)#
    \| \xcd"<:" Type\\
 ClosureBody    \: ConditionalExp & (\ref{prod:ClosureBody})\\%<FROM #(prod:ClosureBody)#
...
\begin{bbgrammar}
 MethodSelection    \: Primary \xcd"." Id \xcd"." \xcd"(" FormalParamList\opt \xcd")" & (\ref{prod:MethodSelection})\\%<FROM #(prod:MethodSelection)#
