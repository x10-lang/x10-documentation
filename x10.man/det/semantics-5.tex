...
$\typerule{
 \hB,\cH \preduce \hB',\cH' ~|~ \cH' ~|~ \err
    ...
    \hfinish~\hB,\cH \ptreduce \hfinish~\hB',\cH'  ~|~ \cH' ~|~ \err \gap \pi=\hAcc(\pi')\\
...
\\\\
$\typerule{
\hS_1\stuck\gap \ol{\hm}\subseteq\ol{\hl}\gap \hS,\cH \preduce \hS',\cH' ~|~ \cH' ~|~ \err
}{
   \blockt{\ol{\hl}}{\hS_1~\hclocked~\finish{\ol{\hm}}{\hS}},\cH \preduce \\
\quad\quad\quad   \blockt{\ol{\hl}}{\hS_1~\hclocked~\finish{\ol{\hm}}{\hS'}},\cH' ~|~ \cH' ~|~ \err 
}$~\RULE{(R-Trans-CF)}
~
$\typerule{
\hS_1\stuck\gap \ol{\hm}\not\subseteq\ol{\hl}
}{
   \blockt{\ol{\hl}}{\hS_1~\hclocked~\finish{\ol{\hm}}{\hS}},\cH \preduce \err 
}$~\RULE{(R-CF-F)}
\\\\
$\typerule{
    \hS_1\stuck\gap\hl \not \in \dom(\cH)
}{
\blockt{\ol{\hm}}{\hS_1~\valt{\hx}{\hnew{\hAcc(\hr,\hz)}}~\hS},\cH \preduce 
   \blockt{\ol{\hm},\hl}{\hS_1~\hS[\hl/\hx]},\cH[ \hl \mapsto \hAcc(\hr,\hz)] \\
