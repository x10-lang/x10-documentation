...
%%%\begin{figure}[!htbp]
%%START X10: src/intro/MontePi1.x10 mpi1 [frame=tb, caption={Serial Monte Carlo Approximation of Pi},label={fig:mcpi},float=tb]
...
%%START X10: src/intro/MontePiAsync.x10 mpia [frame=tb, caption={Shared-memory parallel code for computing $\pi$},label={fig:mcpm},float=tb]
...
\end{xten} 
means: 
\bard{s/thread/activity/ in the following}
\begin{quote}
...
in \figref{fig:mcpmtmc}. 
%%START X10: src/intro/MontePiCluster.x10 mpicluster [frame=tb, caption={Multi-Place, Multi-Activity Monte Carlo Approximation of {$\pi$}},label={fig:mcpmtmc},float=tb]
\fromfile{MontePiCluster.x10}
\begin{xtennum}[frame=tb, caption={Multi-Place, Multi-Activity Monte Carlo Approximation of {$\pi$}},label={fig:mcpmtmc},float=tb]
import x10.util.Random;
/**
...
%%START X10: src/intro/MontePiCluster.x10 mpicluster2 [frame=tb, caption={Multi-Place, Multi-Activity Monte Carlo Approximation of {$\pi$}, continued},label={fig:mcpmtmc},float=tb]
\fromfile{MontePiCluster.x10}
\begin{xtennum}[frame=tb, caption={Multi-Place, Multi-Activity Monte Carlo Approximation of {$\pi$}, continued},label={fig:mcpmtmc},float=tb]
   /**
...
\end{xtennum}
%%END X10: src/intro/MontePiCluster.x10 mpicluster2
