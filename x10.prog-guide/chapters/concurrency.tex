...
%%START X10: src/concurrency/PlaceCounter.x10 placecounter
...
\end{xtennum}
%%END X10: src/concurrency/PlaceCounter.x10 placecounter
...
%%START src/concurrency/NestAsyncs.x10 nestasyncs 
\begin{verbatim}
...
11   }
\end{verbatim}
%%END src/concurrency/NestAsyncs.x10 nestasyncs 
...
%%START src/concurrency/IndirectAsyncs.x10 indasyncs 
\begin{verbatim}
 1   var a:Boolean = false, b:Boolean = false, c:Boolean = false;
 2   def spawnAsyncs() { 
 3      async {a = true;}
...
14   }
\end{verbatim}
%%END src/concurrency/IndirectAsyncs.x10 indasyncs 
